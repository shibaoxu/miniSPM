        ...
        <div class="span2">
            <div class="well sidebar-nav">
                <ul class="nav nav-list">
                    <li class="nav-header">机会与线索</li>
                    <li id='sidebar_market_action'><a href="${ctx}/sale/market_action/index"><i class="icon-bullhorn"></i>市场活动</a></li>
